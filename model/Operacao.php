...
class Operacao
{
    ...
    function getDicastb()
    {
        ...
        $stmt->execute();
        $stmt->bind_result($uid, $regiao, $estado, $cidade, $imgLogo, $imgPoTur01, $imgGast, $pontosturisticos, $gastronomilocal, $endereco);
    ...
    function updateDicastb($campo_1, $campo_2, $campo_3, $campo_4, $campo_5, $campo_6, $campo_7, $campo_8, $campo_9, $campo_10)
    {
        ...
        $stmt = $this->con->prepare("update dicastb set regiao=?, estado=?, cidade=?, imgLogo=?, imgPoTur01=?, imgGast=?, pontosturisticos=?, gastronomialocal=?, endereco=? where uid=?");
